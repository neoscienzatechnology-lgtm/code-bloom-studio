...
const SCENES: Record<DiagramFamily, (t: VisualTone) => ReactNode> = {
  ...
  variable: (t) => (
    <>
      <rect x="96" y="62" width="64" height="28" rx="14" fill="#ffffff" stroke={t.accent} strokeWidth="3" />
      ...
      <rect x="232" y="52" width="120" height="66" rx="14" fill="#ffffff" stroke={t.primary} strokeWidth="4" />
  ...
  text: (t) => (
    <>
      ...
      <rect x="162" y="52" width="196" height="58" rx="14" fill="#ffffff" stroke={t.secondary} strokeWidth="3.5" />
  ...
  list: (t) => (
    <>
      <g>
        {[0, 1, 2].map((i) => (
          <g key={i}>
            <rect x={128 + i * 96} y="44" width="80" height="52" rx="12" fill="#ffffff" stroke={t.primary} strokeWidth="3.5" />
  ...
  loop: (t) => (
    <>
      ...
      <rect x="240" y="58" width="40" height="36" rx="10" fill="#ffffff" stroke={t.secondary} strokeWidth="3.5" />
  ...
  condition: (t) => (
    <>
      ...
      <rect x="236" y="56" width="44" height="40" rx="11" fill="#ffffff" stroke={t.primary} strokeWidth="4" transform="rotate(45 258 76)" />
  ...
  func: (t) => (
    <>
      <rect x="104" y="62" width="62" height="28" rx="14" fill="#ffffff" stroke={t.accent} strokeWidth="3" />
      ...
      <rect x="218" y="42" width="106" height="68" rx="16" fill="#ffffff" stroke={t.primary} strokeWidth="4" />
  ...
  dict: (t) => (
    <>
      <rect x="180" y="28" width="160" height="98" rx="14" fill="#ffffff" stroke={t.primary} strokeWidth="4" />
      {[0, 1, 2].map((i) => (
        <g key={i}>
          <rect x="192" y={40 + i * 30} width="136" height="22" rx="7" fill={i === 1 ? t.soft : "#ffffff"} stroke={t.secondary} strokeWidth="2.5" />
  ...
  error: (t) => (
    <>
      <rect x="142" y="40" width="180" height="74" rx="14" fill="#ffffff" stroke={t.primary} strokeWidth="3.5" />
      ...
      <circle cx="296" cy="78" r="26" fill="#ffffff" fillOpacity="0.55" stroke={t.secondary} strokeWidth="5" />
  ...
  web: (t) => (
    <>
      <rect x="160" y="28" width="200" height="100" rx="12" fill="#ffffff" stroke={t.primary} strokeWidth="3.5" />
      ...
      <rect x="292" y="78" width="56" height="40" rx="8" fill="#ffffff" stroke={t.accent} strokeWidth="2.5" />
  ...
  style: (t) => (
    <>
      <rect x="128" y="48" width="108" height="64" rx="12" fill="#ffffff" stroke="#9aa3af" strokeWidth="3" strokeDasharray="6 6" />
  ...
  data: (t) => (
    <>
      <rect x="150" y="34" width="190" height="88" rx="12" fill="#ffffff" stroke={t.primary} strokeWidth="3.5" />
  ...
  flow: (t) => (
    <>
      ...
      <circle cx="150" cy="96" r="10" fill="#ffffff" stroke={t.primary} strokeWidth="4" />
      <circle cx="264" cy="50" r="10" fill="#ffffff" stroke={t.accent} strokeWidth="4" />
      <circle cx="312" cy="50" r="10" fill="#ffffff" stroke={t.accent} strokeWidth="4" />
      <circle cx="260" cy="96" r="10" fill="#ffffff" stroke={t.primary} strokeWidth="4" />
  ...
  mobile: (t) => (
    <>
      <rect x="222" y="20" width="76" height="116" rx="16" fill="#ffffff" stroke={t.primary} strokeWidth="4" />
