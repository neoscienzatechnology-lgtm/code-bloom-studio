...
Avatares, logos e capas seguem esse padrão.`,
        ...
        solution: 'import { Image } from "react-native";\n\n<Image source={{ uri: "https://exemplo.com/avatar.png" }} style={{ width: 120, height: 120 }} />;',
...
Análise boa começa simples e verificável.`,
        ...
        expectedOutput: "8.333333333333334",
...
IA funciona melhor quando você dá direção, exemplos e critérios de qualidade.`,
        ...
        expectedOutput: "Objetivo: resumir vendas. Formato: 3 tópicos.",
...
O importante é deixar cada etapa verificável.`,
        ...
        expectedOutput: "Relatório: total 300, média 100",
...
const supplementalLessonEnhancements: Record<string, LessonEnhancement> = {
  ...
  "11-8": {
    contrastExample: {
      wrong: '<Image source={{ uri: "https://exemplo.com/avatar.png" }} />  /* nada aparece */',
      right: '<Image source={{ uri: "https://exemplo.com/avatar.png" }} style={{ width: 120, height: 120 }} />',
      explanation:
    ...
    practiceActivities: [
      {
        ...
        code: '<Image source={{ ____: "https://exemplo.com/avatar.png" }} style={{ width: 96, height: 96 }} />',
        correctAnswer: "uri",
